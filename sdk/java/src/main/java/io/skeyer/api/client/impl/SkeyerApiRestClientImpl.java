...
import io.skeyer.api.client.domain.account.*;
import io.skeyer.api.client.domain.account.request.*;
import io.skeyer.api.client.domain.general.BrokerInfo;
import io.skeyer.api.client.domain.market.*;
import io.skeyer.api.client.service.SkeyerApiService;
...
/**
 * Implementation of Skeyer's REST API using Retrofit with synchronous/blocking method calls.
 */
public class SkeyerApiRestClientImpl implements SkeyerApiRestClient {

    private final SkeyerApiService bHexApiService;

    public SkeyerApiRestClientImpl(String baseUrl, String apiKey, String secret) {
        bHexApiService = createService(baseUrl, SkeyerApiService.class, apiKey, secret);
    }
