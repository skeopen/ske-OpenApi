...
import io.skeyer.api.client.domain.general.ServerTime;
...
/**
 * Skeyer's REST API URL mappings and endpoint security configuration.
 */
public interface SkeyerApiService {

    // General endpoints
    @GET("/openapi/quote/v1/ping")
    @Headers(SkeyerConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    Call<Void> ping();
