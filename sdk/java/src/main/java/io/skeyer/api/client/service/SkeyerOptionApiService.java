package io.skeyer.api.client.service;

import java.util.List;

import io.skeyer.api.client.constant.SkeyerConstants;
import io.skeyer.api.client.domain.account.OrderSide;
import io.skeyer.api.client.domain.account.OrderStatus;
import io.skeyer.api.client.domain.account.OrderType;
import io.skeyer.api.client.domain.account.TimeInForce;
...
/**
 * Skeyer's Option REST API URL mappings and endpoint security configuration.
 */
public interface SkeyerOptionApiService {

    @Headers(SkeyerConstants.ENDPOINT_SECURITY_TYPE_SIGNED_HEADER)
