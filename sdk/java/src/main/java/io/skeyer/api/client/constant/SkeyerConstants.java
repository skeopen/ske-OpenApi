package io.skeyer.api.client.constant;

import org.apache.commons.lang3.builder.ToStringStyle;

public class SkeyerConstants {

    public static final long DEFAULT_RECEIVING_WINDOW = 5_000L;

    public static final String API_BASE_URL = "https://api.skeyer.com/";

    /**
     * Streaming API base URL.
     */
    public static final String WS_API_BASE_URL = "wss://wsapi.skeyer.com/openapi/quote/ws/v1";

    public static final String WS_API_USER_URL = "wss://wsapi.skeyer.com/openapi/ws/";
